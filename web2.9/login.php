		...
		<div class="container">
			<div class="row formulario">
				...
				<div class="col-sm-6">
					...
					<form action="php/ingresar.php" method="POST" id="sesion">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Usuario</label>
                            <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nombre de Usuario" name="usuario" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Contraseña</label>
